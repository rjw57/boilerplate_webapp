...
.. code-block:: bash
    ...
    $ git clone git@github.com:uisautomation/boilerplate_webapp.git
    $ cd boilerplate_webapp
    $ git remote set-url origin --push git@github.com:$USER/boilerplate_webapp.git
...
.. code-block:: bash
    ...
    $ git remote add $USER git@github.com:$USER/boilerplate_webapp.git
...
:py:class:`boilerplate_webapp_project.settings.developer` settings,
