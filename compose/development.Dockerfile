...
# The Boilerplate Webapp source will be mounted here as a volume
VOLUME /usr/src/app
...
ENV DJANGO_SETTINGS_MODULE boilerplate_webapp_project.settings_developer
ENTRYPOINT ["/tmp/wait-for-it.sh", "boilerplate_webapp-db:5432", "--"]
