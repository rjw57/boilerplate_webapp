"""
The :py:mod:`boilerplate_webapp_project.settings_testsuite` module contains settings which are
...
#: when running tests.
TEST_RUNNER = 'boilerplate_webapp_project.test.runner.BufferedDiscoverRunner'
